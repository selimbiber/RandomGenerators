...
async function changeCurrentAdvice() {
    ...
    document.querySelector('.advice-generator-card_heading').innerHTML = `ADVICE #${ADVICE_DATA.slip.id}`;
    document.querySelector('.advice-generator-card_text').textContent = ADVICE_DATA.slip.advice;
}
...
function createFooterSection() {
    ...
    FOOTER_SECTION.className = 'footer-section';
        ...
        const FRONTEND_MENTOR_LINK = document.createElement('a');
            ...
            FRONTEND_MENTOR_LINK.href = 'https://www.frontendmentor.io/challenges/advice-generator-app-QdUG-13db/hub';
        ...
        const GITHUB_REPO_LINK = document.createElement('a');
            GITHUB_REPO_LINK.href = 'https://github.com/selimbiber/RandomGenerators/blob/main/RandomAdviceGenerator';
...
document.addEventListener('DOMContentLoaded', createFooterSection);